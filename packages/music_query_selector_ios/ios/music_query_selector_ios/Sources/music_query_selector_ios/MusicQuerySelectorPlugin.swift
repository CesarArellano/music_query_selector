...
@objc(MusicQuerySelectorPlugin)
public class MusicQuerySelectorPlugin: NSObject, FlutterPlugin {
    private static let CHANNEL_NAME: String = "com.lucasjosino.music_query_selector"
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = MusicQuerySelectorPlugin()
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case Method.PERMISSION_REQUEST:
            // Dispatch to a background thread so the semaphore in requestPermission()
            // doesn't block the main thread and cause a deadlock.
