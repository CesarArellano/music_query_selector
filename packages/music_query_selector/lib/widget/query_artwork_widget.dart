...
part of '../music_query_selector.dart';
...
///
/// See more: [QueryArtworkWidget](https://pub.dev/documentation/music_query_selector/latest/music_query_selector/QueryArtworkWidget-class.html)
class QueryArtworkWidget extends StatelessWidget {
  ...
  /// * If [controller] is null, will be create a new instance.
  /// * Log set with [setLogConfig] will only work if [controller] is not null.
  final MusicQuerySelector? controller;
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Uint8List?>(
      future: (controller ?? MusicQuerySelector()).queryArtwork(
        id,
        type,
        format: format,
        size: size,
