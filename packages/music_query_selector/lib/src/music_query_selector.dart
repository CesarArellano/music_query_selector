...
/// Interface and Main method for use music_query_selector
class MusicQuerySelector {
  /// The platform interface that drives this plugin
  static MusicQuerySelectorPlatform get platform => MusicQuerySelectorPlatform.instance;
