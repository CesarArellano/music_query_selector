...
import 'music_query_selector_platform_interface.dart';

const MethodChannel _channel = MethodChannel('com.lucasjosino.music_query_selector');

/// An implementation of [MusicQuerySelectorPlatform] that uses method channels.
class MethodChannelMusicQuerySelector extends MusicQuerySelectorPlatform {
